...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    public class ZeroGexGammaLevels : Indicator
    {
        ...
        /// <summary>The chart's instrument, normalized to what the API knows.
        ///
        ...
        // a level that had held, leaving unlabeled lines and, in his words,
        ...
        /// the chart repaints. There are only ever nine distinct colors, so
        ...
        /// the wall's color, and stays solid unless every part of it is
        /// dashed.</summary>
        ...
        private void RenderLevels(ChartScale chartScale, SharpDX.DirectWrite.TextFormat font, BrushCache brushes)
        {
            ...
            for (int i = 0; i < _levels.Count; i++)
            {
                ...
                // simpler than sorting afterward.
        ...
        /// answered to v1.9: one with the light-chart panel color, one with
        ...
        // Range DELIBERATELY stays wider than the interval we actually honor.
        //
        ...
        // The panel used to be a Draw.TextFixed object, which took its color
