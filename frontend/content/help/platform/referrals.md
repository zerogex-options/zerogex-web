...
The program is enabled per-account based on configuration. If you don't see a Referrals panel on your Account page, the program isn't currently enabled for your account.
