...
Si le programme de parrainage est activé pour votre compte, vous verrez :

- Votre code de parrainage
- Votre lien de parrainage
- Le nombre total d'inscriptions via votre code
- Le nombre total converti en abonnement payant
- Les mois gagnés
- Les mois cumulés (crédit sur votre prochaine facture)

Pour les règles du programme, consultez [Referrals](/help/platform/referrals).

## Se déconnecter

En haut à droite de la plateforme. Efface le cookie de session. Reconnectez-vous depuis [/login](/login).

## Supprimer votre compte

Envoyez un email à [support@zerogex.io](mailto:support@zerogex.io) pour supprimer votre compte. La suppression du compte annule tout abonnement actif et retire les données de votre compte conformément à notre politique de [Privacy](/privacy).
