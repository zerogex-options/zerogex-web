...
*La barra lateral, el selector de símbolos, el selector de intervalo temporal, los interruptores de tema y los atajos de teclado que agilizan el trabajo.*
...
La cabecera permanece fija en la parte superior de cada página de análisis y muestra:
...
ZeroGEX está disponible en modo oscuro y claro. El predeterminado es el oscuro. El interruptor está en la cabecera. La preferencia se guarda por navegador.
...
## El botón Live Bulletin

El enlace Live Bulletin en la barra lateral muestra una pequeña insignia cuando hay eventos sin leer desde la última vez que lo abriste. Al hacer clic, la insignia desaparece.

## Elementos de menú según el plan

Si no tienes acceso a una página, al hacer clic el elemento del menú te lleva a [Pricing](/pricing) en lugar de a la página restringida. Las entradas exclusivas de administrador se ocultan por completo.

## Recorrido rápido por la estructura de las páginas
