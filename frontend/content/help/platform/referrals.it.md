...
## Cos'è il programma di referral
...
Il programma è attivato per singolo account in base alla configurazione. Se non vedi un pannello Referral nella tua pagina Account, il programma non è attualmente attivo per il tuo account.
