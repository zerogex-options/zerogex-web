...
- **Le temps.** À mesure que l'échéance approche, le delta dérive même lorsque le spot est figé : les options out-of-the-money glissent vers un delta de 0, les options in-the-money évoluent vers un delta de ±1 (+1 pour les calls, −1 pour les puts). La sensibilité du delta au temps, c'est le **charm**. Il tourne en continu, que quelque chose se passe ou non.
