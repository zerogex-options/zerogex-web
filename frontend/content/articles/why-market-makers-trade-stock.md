...
- **Time.** As expiry approaches, delta drifts even with spot pinned: out-of-the-money options bleed toward delta 0, in-the-money options move toward delta ±1 (+1 for calls, −1 for puts). The sensitivity of delta to time is **charm**. It runs continuously, whether or not anything happens.
...
That is what the rest of this series unpacks. [Delta and Its Three Children](/education/delta-and-its-three-children) breaks down gamma, charm, and vanna as the three derivatives of delta. [Charm: The Clock Is a Trader](/education/charm-the-clock-is-a-trader) shows how time alone changes modeled delta, conditional on spot, IV, and assumed inventory. [Vanna: How Falling IV Can Change Dealer Hedging](/education/vanna-when-fear-fades) explains the vol-compression grind. And the live [Forced Flow](/forced-flow) page reprices the entire book under any spot/time/vol scenario, so you can see the estimated hedge pressure before it may reach the tape.
