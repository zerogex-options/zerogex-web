...
*Starting today, ZeroGEX is donating 3% of every subscription to Folds of Honor — funding educational scholarships for the spouses and children of fallen and disabled U.S. service members.*

---

## What we're doing

Starting with the current billing cycle, **3% of every ZeroGEX subscription — monthly or annual, founding or standard, basic or pro — is set aside for [Folds of Honor](https://foldsofhonor.org)**. We tally contributions every month and send a single, consolidated donation at the end of each calendar quarter.

The donation is calculated on **gross subscription revenue**, before payment-processing fees and before taxes. We chose gross revenue rather than profit because it is unambiguous, auditable from our Stripe invoices in a few minutes, and removes any incentive to creative-account the donation downward.

Your subscription price does not change. The 3% comes out of ZeroGEX's share of the revenue, not yours.
...
Three things happen for every paid subscription on ZeroGEX:

1. **On every successful Stripe invoice**, the billing system stamps the 3% allocation against that invoice. The total accumulates in a tally we settle at quarter-end.
2. **At the end of each calendar quarter**, the consolidated total is wired to Folds of Honor. We save the receipt and publish the donation on [/giving](/giving).
3. **The running total on /giving updates** with the new donation amount, the date, and the quarter it covered. Past donations stay listed so the history is auditable at a glance.

If you ever want to see exactly how much ZeroGEX has donated to date, that page is the source of truth — not a marketing claim, the actual ledger.
...
If you are a ZeroGEX subscriber: thank you. Every subscription on the platform helps fund a scholarship for a military family. That's the cleanest alignment we have been able to find between what we build and what we believe.

If you are thinking about subscribing: the [free Gamma Levels pages](/spx-gamma-levels) (SPX, SPY, QQQ, and NDX) — delayed about 15 minutes — are always free, and a paid subscription helps both — it unlocks the real-time Dashboard and Pro features, and contributes 3% to Folds of Honor.

Full mechanics, the running donation total, and our FAQ live at [/giving](/giving).
