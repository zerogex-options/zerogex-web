...
This is the most direct modeled measure of hedge flow. The signal sums modeled dealer charm exposure across an at-the-money band, weighted by expiry bucket:
...
The 60/40 weighting is a hand-picked design choice, not a fitted one: it reflects the view that **charm is the more direct modeled measure of hedge flow**, while **pin gravity is an indirect, regime-dependent pull**. Both matter in the model. Charm leads.
