...
## Wie der Call Wall wandert — und warum ein nachziehender Wall wichtig ist

Der Call Wall ist eine Live-Kennzahl, die sich während der Handelssitzung aus drei Gründen bewegt:

1. **OI-Neugewichtung.** Frisches Call-Volumen an einem höheren Strike kann die stärkste Konzentration nach oben verschieben. Der Wall ist immer der *aktuell* dichteste Strike, nicht der von heute Morgen.
...
## Wann ein Ausbruch über den Call Wall wichtig ist

Da Dealer den Call Wall in Positiv-Gamma verteidigen, ist ein *entscheidender* Ausbruch darüber eines der bedeutsameren strukturellen Ereignisse im Tape. Es bedeutet meist eines von zwei Dingen:
...
Angenommen, SPX steht bei 5.830 und das Buch zeigt:
