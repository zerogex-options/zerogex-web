...
Vanna measures delta’s sensitivity to implied volatility. Under the modeled inventory convention, falling IV can create underlying-buying pressure in some chain configurations, but the sign depends on ownership, option type, moneyness, expiry, skew, and the surface move. [Vanna: How Falling IV Can Change Dealer Hedging](/education/vanna-when-fear-fades) walks through the conditional mechanism.
