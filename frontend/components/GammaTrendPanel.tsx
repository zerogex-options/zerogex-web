 ...
 * can be green above it and red below. A single flat colour would misreport
            ...
            <ResponsiveContainer width="100%" height={216}>
              <ComposedChart data={rows} margin={{ top: 8, right: 36, left: 8, bottom: 20 }}>
                ...
                {/* The cushion itself. Tinted by what it is doing — thinning
                    ...
                    above, so the meaning is never carried by colour alone. */}
                <Area
                  type="monotone"
                  dataKey="band"
                  name="Cushion"
...
/** The WCAG-clean twin of the plots — every value reachable without colour,
