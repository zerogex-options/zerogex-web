...
export const dict: PageDictionary = {
  en: {
    ...
    billedQuarterlyNote: '{price} billed every 3 months',
    billedAnnuallyNote: '{price} billed once a year',
    saveHighlight: 'Save {pct}%',
    saveUpToBadge: 'SAVE UP TO {pct}%',
  ...
  it: {
    ...
    billedQuarterlyNote: '{price} fatturati ogni 3 mesi',
    billedAnnuallyNote: "{price} fatturati una volta all'anno",
    saveHighlight: 'Risparmia il {pct}%',
    saveUpToBadge: 'RISPARMIA FINO AL {pct}%',
  ...
  de: {
    ...
    billedQuarterlyNote: '{price} alle 3 Monate abgerechnet',
    billedAnnuallyNote: '{price} einmal jährlich abgerechnet',
    saveHighlight: '{pct} % sparen',
    saveUpToBadge: 'BIS ZU {pct} % SPAREN',
  ...
  es: {
    ...
    billedQuarterlyNote: '{price} facturados cada 3 meses',
    billedAnnuallyNote: '{price} facturados una vez al año',
    saveHighlight: 'Ahorra {pct} %',
    saveUpToBadge: 'AHORRA HASTA {pct} %',
  ...
  fr: {
    ...
    billedQuarterlyNote: '{price} facturés tous les 3 mois',
    billedAnnuallyNote: '{price} facturés une fois par an',
    saveHighlight: 'Économisez {pct} %',
    saveUpToBadge: "JUSQU'À {pct} % D'ÉCONOMIE",
