...
export const dict: PageDictionary = {
  en: {
    ...
    perMonthSuffix: '/mo',
    monthlyPromoNote: 'First {months} months at this rate, then {rack}/mo.',
  ...
  it: {
    ...
    perMonthSuffix: '/mese',
    monthlyPromoNote: 'Primi {months} mesi a questa tariffa, poi {rack}/mese.',
  ...
  de: {
    ...
    monthlyPromoNote: 'Die ersten {months} Monate zu diesem Preis, danach {rack}/Monat.',
  ...
  es: {
    ...
    perMonthSuffix: '/mes',
    monthlyPromoNote: 'Primeros {months} meses a esta tarifa, luego {rack}/mes.',
  ...
  fr: {
    ...
    perMonthSuffix: '/mois',
    monthlyPromoNote: 'Les {months} premiers mois à ce tarif, puis {rack}/mois.',
