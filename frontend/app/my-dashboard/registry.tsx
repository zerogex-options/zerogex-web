...
export const WIDGETS: WidgetDef[] = [
  ...
  {
    id: 'open-interest-by-strike',
    title: 'Open Interest by Strike',
    blurb: 'Strike-level call/put open interest (or notional) as a mirror histogram, stacked by expiration, with spot marked. Toggle OI vs notional and filter expirations.',
    category: 'gamma',
    tier: 'basic',
    icon: Layers,
    defaultSize: 'xl',
