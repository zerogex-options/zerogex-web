...
export async function generateMetadata(): Promise<Metadata> {
  const base: Metadata = articleMetadata('what-is-a-call-wall');
...
export default async function CallWallPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      <ArticleJsonLd slug="what-is-a-call-wall" />
      ...
      <ArticleFaq slug="what-is-a-call-wall" />

      <RelatedArticles slug="what-is-a-call-wall" />

      <GexMethodologyNote />
      <LiveLevelsCTA concept="call wall" />
    </div>
  );
}
