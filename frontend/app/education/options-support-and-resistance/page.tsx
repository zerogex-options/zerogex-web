...
export default function OptionsSupportAndResistancePage() {
    ...
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="zg-feature-shell mt-8 p-6 md:p-8">
        ...
        <h3 className="mb-2 text-xl font-semibold text-[var(--color-text-primary)]">
          See today&apos;s options-based S/R live
        </h3>
        <p className="mb-5 text-sm leading-7 text-[var(--color-text-secondary)]">
          The ZeroGEX free dashboard surfaces today&apos;s call wall, put wall, gamma magnet, and gamma flip — the four structural levels behind most options-based support and resistance.
        </p>
        <Link
