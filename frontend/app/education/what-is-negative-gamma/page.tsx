...
export const generateMetadata = () => articleMetadataLocalized('what-is-negative-gamma');

const articlePath = path.join(process.cwd(), 'content/articles/what-is-negative-gamma.md');

export default async function WhatIsNegativeGammaPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <ArticleFaq slug="what-is-negative-gamma" />
