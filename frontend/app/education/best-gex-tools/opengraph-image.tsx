  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Best GEX Tools, Fairly Compared
        </div>
        <div
          style={{
            marginTop: 24,
        ...
        >
          Real-time vs delayed, 0DTE coverage, methodology, signal quality, and price. The criteria that actually matter when picking a gamma exposure tracker.
        </div>
        <div
          style={{
            position: 'absolute',
