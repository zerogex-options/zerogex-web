...
export default function SqueezeSetupExplainedPage() {
  const markdown = fs.readFileSync(articlePath, 'utf8');

  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      <ArticleJsonLd slug="squeeze-setup-explained" />
      ...
      <RelatedArticles slug="squeeze-setup-explained" />
      ...
      <div className="zg-feature-shell mt-8 p-6 md:p-8">
        ...
        <h3 className="mb-2 text-xl font-semibold text-[var(--color-text-primary)]">
          See today&apos;s Squeeze Setup read live
        </h3>
        <p className="mb-5 text-sm leading-7 text-[var(--color-text-secondary)]">
          The ZeroGEX dashboard surfaces the live Squeeze Setup score alongside the gamma flip, the walls, and the rest of the Advanced and Basic signal stack — the full structural context in one view.
        </p>
        <Link
          href="/dashboard"
