...
export async function generateMetadata(): Promise<Metadata> {
  const base: Metadata = articleMetadata('how-to-avoid-chasing-0dte');
...
export default async function HowToAvoidChasing0DTEPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <ArticleFaq slug="how-to-avoid-chasing-0dte" />

      <RelatedArticles slug="how-to-avoid-chasing-0dte" />

      <LiveLevelsCTA concept="0DTE dealer positioning" />
    </div>
  );
}
