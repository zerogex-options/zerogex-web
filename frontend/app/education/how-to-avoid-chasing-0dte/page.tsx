...
export default function HowToAvoidChasing0DTEPage() {
  const markdown = fs.readFileSync(articlePath, 'utf8');

  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      <ArticleJsonLd slug="how-to-avoid-chasing-0dte" />
      ...
      <RelatedArticles slug="how-to-avoid-chasing-0dte" />
      ...
      <div className="zg-feature-shell mt-8 p-6 md:p-8">
        ...
        <h3 className="mb-2 text-xl font-semibold text-[var(--color-text-primary)]">
          Check the regime before your next 0DTE entry
        </h3>
        <p className="mb-5 text-sm leading-7 text-[var(--color-text-secondary)]">
          The ZeroGEX free dashboard surfaces the gamma flip, Net GEX, and the wall positioning — the three filters that flag most 0DTE chase setups before you click.
        </p>
        <Link
