...
export default function WhyDoBreakoutsFailPage() {
    ...
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="zg-feature-shell mt-8 p-6 md:p-8">
        ...
        <h3 className="mb-2 text-xl font-semibold text-[var(--color-text-primary)]">
          See today&apos;s walls and regime before your next breakout trade
        </h3>
        <p className="mb-5 text-sm leading-7 text-[var(--color-text-secondary)]">
          The ZeroGEX free dashboard surfaces the gamma flip, Net GEX, and the live wall positioning that decide whether the next breakout extends or fades.
        </p>
        <Link
