...
export const dict: PageDictionary = {
  en: {
    ...
    referralNoSignups: 'No sign-ups yet',
    referralNoSubscribers: 'No subscribers yet',
  ...
  it: {
    ...
    signedUp: 'Iscritti',
    subscribed: 'Abbonati',
    referralNoSignups: 'Ancora nessun iscritto',
    referralNoSubscribers: 'Ancora nessun abbonato',
  ...
  de: {
    ...
    referralNoSubscribers: 'Noch keine Abonnenten',
  ...
  es: {
    ...
    referralNoSubscribers: 'Aún no hay suscriptores',
  ...
  fr: {
    ...
    referralNoSubscribers: 'Aucun abonné pour l’instant',
