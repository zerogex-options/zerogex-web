...
const PRIMARY_PAGES: Entry[] = [
  ...
  { title: 'ZeroGEX Pricing: Basic & Pro Plans, Free Trial on Basic', href: '/pricing', kind: 'Page', blurb: 'ZeroGEX plans and pricing\u00a0- free delayed levels plus real-time dashboard tiers. 7-day free trial on Basic monthly · 7-day money-back guarantee on every other plan.' },
