...
const PRIMARY_PAGES: Entry[] = [
  ...
  { title: 'NDX Gamma Levels Today: Gamma Flip, Call Wall, Put Wall & Net GEX', href: '/ndx-gamma-levels', kind: 'Live levels', blurb: 'Free daily NDX gamma levels — the gamma flip, call wall, put wall, max pain, and net dealer GEX. Delayed 15 minutes, no signup.' },
