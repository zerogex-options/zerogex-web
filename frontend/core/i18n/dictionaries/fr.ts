...
export const fr: Dictionary = {
  ...
  'register.trialInfo':
    'Choisissez votre offre après la création du compte : essai gratuit de 7 jours sur Basic mensuel · garantie satisfait ou remboursé de 7 jours sur toutes les autres offres.',
  'register.valueProp':
  ...
  'register.submit': 'Créer le compte et choisir une offre',
  'register.submitting': 'Création du compte…',
  'register.nextStep': 'Étape suivante : choisissez votre offre.',
  ...
  'nav.group.receipts': 'Justificatifs',
  'nav.sessionReplay': 'Rejouer la séance',
  'nav.forecastOneDay': 'Prévision - un jour',
  'nav.forecastIntraday': 'Prévision - cône intrajournalier',
  'nav.forecastAllTime': 'Prévision - historique',
  'nav.signalsOneDay': 'Signaux - un jour',
  ...
  'footer.faqs': 'FAQ',
  'footer.tagline':
    'Exposition gamma en temps réel et positionnement des teneurs de marché pour les traders SPX, SPY, QQQ et NDX.',
  'footer.founderBuilt': 'Conçu et géré par son fondateur, Michael',
  ...
  'login.continueAppleSoon': 'Continuer avec Apple (bientôt disponible)',
