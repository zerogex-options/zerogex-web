...
export const de: Dictionary = {
  ...
  'nav.group.receipts': 'Belege',
  'nav.sessionReplay': 'Session-Replay',
  'nav.forecastOneDay': 'Prognose - ein Tag',
  'nav.forecastIntraday': 'Prognose - Intraday-Cone',
  'nav.forecastAllTime': 'Prognose - Gesamtbilanz',
  'nav.signalsOneDay': 'Signale - ein Tag',
  'nav.group.education': 'Wissen',
  'nav.group.admin': 'Admin',
  'nav.group.more': 'Mehr',
  'nav.group.favorites': 'Favoriten',
  'nav.addFavorite': '{name} zu Favoriten hinzufügen',
  'nav.removeFavorite': '{name} aus Favoriten entfernen',
  ...
  'footer.updates': 'Neuigkeiten',
  'footer.methodology': 'Methodik & Validierung',
  ...
  'footer.faqs': 'FAQ',
  'footer.tagline':
    'Echtzeit-Gamma-Exposure und Dealer-Positionierung für SPX-, SPY-, QQQ- und NDX-Trader.',
  'footer.founderBuilt': 'Vom Gründer Michael gebaut und betrieben',
  ...
  'login.continueAppleSoon': 'Mit Apple fortfahren (bald verfügbar)',
