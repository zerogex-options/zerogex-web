...
export const en = {
  ...
  'nav.group.receipts': 'Receipts',
  'nav.sessionReplay': 'Session replay',
  'nav.forecastOneDay': 'Forecast - one day',
  'nav.forecastIntraday': 'Forecast - intraday cone',
  'nav.forecastAllTime': 'Forecast - all time',
  'nav.signalsOneDay': 'Signals - one day',
  ...
  'login.continueAppleSoon': 'Continue with Apple (coming soon)',
