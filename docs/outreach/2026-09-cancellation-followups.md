...
Five members cancelled between 2026-08-10 and 2026-08-30. Each left a written
...
**Cancelled** 2026-08-28 · reason: *"I want data for FUTURES, ES, MES, NASDAQ"*
**Still has access** (cancel is pending, not lapsed).

### The read

They cancelled asking for the feature that had **already shipped**, and they
...
| 2026-08-27 | **ES / NQ switched to real-time CME** (`55c9352`) — the day before they cancelled |
...
>
> Hi — I saw you cancelled last week, and the reason you left was futures data:
> ES, MES, Nasdaq.
>
...
> the 23rd, and on the 27th — the day before you cancelled — they moved onto a
> real-time CME feed.
>
...
**Cancelled** 2026-08-28 · reason: *other* — *"Repeatedly failed to connect using my API"*
...
cancelled saying it never connected. There is no support request because there
...
>
> Hi Marcos — you cancelled last week and the reason you gave was that you
...
**Cancelled** 2026-08-28 · reason: `too_expensive` — *"I like the Ninjatrader
...
**Cancelled** 2026-08-30 · reason: *other* — *"Interesting concept, still can't
...
>
> Hi — you cancelled with "interesting concept, still can't see how this would
...
**Cancelled** 2026-08-10 · reason: *other* — *"If I find it useful and accurate,
...
the label "cancelled" is just doing a poor job of describing it.
...
The alert shows tenure, so a `same day` cancel is easy to recognise on sight.
